...
| SHIFT + ALT + @ | 選択したファイルを規定のアプリで開く( コマンドパレットを開く )
...
## [対話型プレイグラウンドの翻訳リポジトリ](https://github.com/satokaz/tips/blob/master/vscode/walkThrough/vs_code_editor_walkthrough.md)
